...
public class Firma {
    ...
    public static void main(String[] args) {
        ...
        if (primerParcial >= 7 && segundoParcial >= 7 && total >= 14) {
            System.out.println("\n✅ ¡Felicidades! Aprobaste directamente con un total de " + total);
        } else {
            System.out.println("\n⚠️ No alcanzaste los requisitos mínimos. Debes rendir el examen de calificación.");
